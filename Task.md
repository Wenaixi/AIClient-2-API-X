...
### 已完成
- [x] 创建规范文档（Requirement.md, Design.md, Task.md, AGENTS.md）
- [x] 测试基础设施搭建（1264 测试，31 套件）
- [x] Kimi OAuth 集成
- [x] iFlow 提供商支持恢复
- [x] LRU Adapter Cache 实现（带 TTL 滑动过期）
- [x] Provider Pool Manager 重构
- [x] 健康检查定时器修复
- [x] 安全漏洞修复（日志脱敏、路径保护）
- [x] 多提供商支持（OpenAI/Claude/Gemini/Kimi/Grok/iFlow/Codex/Qwen）
- [x] 405095a Codex PR 审查修复
...
| e1cb14e | chore: 备份 pro 分支 - 确认 LRU Cache TTL 优化完成 |
| 88df2c4 | chore: 备份 pro 分支优化状态 |
...
- [x] Cache 模块对比：sync.Map分组 vs LRU Cache + TTL
...
- [x] 借鉴 Go 的缓存设计优化 Node.js LRU Cache（TTL 滑动过期）
