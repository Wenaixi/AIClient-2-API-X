...
const translations = {
    'zh-CN': {
        ...
        'config.healthCheck.interval': '异常检查间隔',
        'config.healthCheck.intervalNote': '当供应商处于异常状态时的检查间隔',
        ...
        'config.healthCheck.healthyInterval': '健康检查间隔',
        'config.healthCheck.healthyIntervalNote': '当供应商处于健康状态时的检查间隔，设为0则不检查健康供应商',
    ...
    'en-US': {
        ...
        'config.healthCheck.interval': 'Abnormal Check Interval',
        ...
        'config.healthCheck.defaultInterval': 'Abnormal Check Interval',
        ...
        'config.healthCheck.healthyIntervalNote': 'Check interval for healthy providers. Set to 0 to skip checking healthy providers.',
