...
const translations = {
    'zh-CN': {
        ...
        'oauth.kimi.title': 'Kimi OAuth 设备流认证',
        'oauth.kimi.deviceFlow': '设备流认证',
        'oauth.kimi.deviceFlowDesc': '使用设备码在浏览器中完成授权',
        'oauth.kimi.batchImport': '批量导入 Refresh Tokens',
        'oauth.kimi.batchImportDesc': '批量导入已有的 Kimi refresh tokens',
        'oauth.kimi.importInstructions': '请输入 Kimi refresh tokens，每行一个',
        'oauth.kimi.tokensLabel': 'Refresh Tokens',
        'oauth.kimi.tokenCount': 'Token 数量',
        'oauth.kimi.noTokens': '请输入有效的 Token 数据',
        'oauth.kimi.importing': '正在导入...',
        'oauth.kimi.startImport': '开始导入',
        'oauth.kimi.step1': '点击下方按钮在浏览器中打开授权页面',
        'oauth.kimi.step2': '在页面中输入设备码或使用已填充的链接完成授权',
        'oauth.kimi.step3': '授权完成后点击下方按钮完成认证',
        'oauth.kimi.step4': '凭据文件可在上传配置管理中查看和管理',
        'oauth.kimi.enterCode': '请在授权页面输入以下设备码',
        ...
        'config.advanced.baseDelay': '重试基础延迟',
        ...
        'config.healthCheck.interval': '全局默认间隔',
        'config.healthCheck.intervalNote': '设置定时健康检查的执行间隔，范围：1秒 ~ 24小时',
        'config.healthCheck.hours': '时',
        'config.healthCheck.minutes': '分',
        'config.healthCheck.seconds': '秒',
        'config.healthCheck.providerTypes': '定时检查的供应商',
        'config.healthCheck.providerTypesNote': '选择需要进行定时健康检查的供应商类型，留空则不进行任何检查。提示：右键已勾选的供应商可以自定义检查间隔',
        'config.healthCheck.defaultInterval': '默认间隔',
        'config.healthCheck.intervalOverride': '自定义间隔（留空使用全局默认）',
        'config.healthCheck.intervalSaved': '间隔设置已保存',
        'config.healthCheck.intervalReset': '已重置为全局默认',
        'config.healthCheck.intervalAdded': '已添加自定义间隔',
        'config.healthCheck.intervalRemoved': '已移除自定义间隔',
        'config.healthCheck.intervalTooShort': '间隔时间不能少于1秒',
        'config.healthCheck.intervalUpdated': '已更新自定义间隔',
        'config.healthCheck.useDefault': '使用全局默认',
        'config.healthCheck.customInterval': '自定义间隔',
        'config.healthCheck.customIntervals': '自定义间隔配置',
        'config.healthCheck.selectProvider': '选择供应商',
        'config.healthCheck.selectProviderFirst': '请先在上方选择供应商',
        'config.healthCheck.noCustomIntervals': '暂无自定义间隔配置',
        'config.healthCheck.confirmDelete': '确定要删除这个自定义间隔吗？',
        'config.healthCheck.addCustomInterval': '添加自定义间隔',
        'config.healthCheck.add': '添加',
        'config.healthCheck.healthyInterval': '健康检查常数',
        'config.healthCheck.healthyIntervalNote': '健康供应商的检查间隔，设为0则不对健康供应商进行检查。异常供应商始终按上方间隔检查。范围：0（不检查）~ 24小时',
        'config.healthCheck.healthyCustomIntervals': '健康自定义间隔',
        'common.actions': '操作',
        'common.save': '保存',
        'common.update': '更新',
        'common.cancel': '取消',
        ...
        'modal.provider.field.oauthPath.kimi.placeholder': '例如: configs/kimi/oauth_creds.json',
        ...
        'tutorial.main.retry.delay': '重试基础延迟',
    ...
    'en-US': {
        ...
        'oauth.kimi.title': 'Kimi OAuth Device Flow',
        'oauth.kimi.deviceFlow': 'Device Flow',
        'oauth.kimi.deviceFlowDesc': 'Use device code to complete authorization in browser',
        'oauth.kimi.batchImport': 'Batch Import Refresh Tokens',
        'oauth.kimi.batchImportDesc': 'Batch import existing Kimi refresh tokens',
        'oauth.kimi.importInstructions': 'Please enter Kimi refresh tokens, one per line',
        'oauth.kimi.tokensLabel': 'Refresh Tokens',
        'oauth.kimi.tokenCount': 'Token Count',
        'oauth.kimi.noTokens': 'Please enter valid Token data',
        'oauth.kimi.importing': 'Importing...',
        'oauth.kimi.startImport': 'Start Import',
        'oauth.kimi.step1': 'Click the button below to open the authorization page in your browser',
        'oauth.kimi.step2': 'Enter the device code or use the pre-filled link on the page to complete authorization',
        'oauth.kimi.step3': 'After authorization, click the button below to complete authentication',
        'oauth.kimi.step4': 'Credentials files can be viewed and managed in Upload Config',
        'oauth.kimi.enterCode': 'Please enter the following device code on the authorization page',
        ...
        'config.healthCheck.interval': 'Default Interval',
        'config.healthCheck.intervalNote': 'Set the interval for scheduled health checks. Range: 1 second ~ 24 hours',
        'config.healthCheck.hours': 'h',
        'config.healthCheck.minutes': 'm',
        'config.healthCheck.seconds': 's',
        ...
        'config.healthCheck.defaultInterval': 'Default Interval',
        'config.healthCheck.intervalOverride': 'Custom Interval (leave empty for global default)',
        'config.healthCheck.intervalSaved': 'Interval saved',
        'config.healthCheck.intervalReset': 'Reset to default',
        'config.healthCheck.intervalAdded': 'Custom interval added',
        'config.healthCheck.intervalRemoved': 'Custom interval removed',
        'config.healthCheck.intervalTooShort': 'Interval must be at least 1 second',
        'config.healthCheck.intervalUpdated': 'Custom interval updated',
        'config.healthCheck.useDefault': 'Use Default',
        'config.healthCheck.customInterval': 'Custom Interval',
        'config.healthCheck.customIntervals': 'Custom Intervals',
        'config.healthCheck.selectProvider': 'Select Provider',
        'config.healthCheck.selectProviderFirst': 'Select providers above first',
        'config.healthCheck.noCustomIntervals': 'No custom intervals configured',
        'config.healthCheck.confirmDelete': 'Are you sure you want to delete this custom interval?',
        'config.healthCheck.addCustomInterval': 'Add Custom Interval',
        'config.healthCheck.add': 'Add',
        'config.healthCheck.healthyInterval': 'Healthy Check Interval',
        'config.healthCheck.healthyIntervalNote': 'Check interval for healthy providers. Set to 0 to skip checking healthy providers. Unhealthy providers always use the interval above. Range: 0 (skip) ~ 24 hours',
        'config.healthCheck.healthyCustomIntervals': 'Healthy Custom Intervals',
        ...
        'modal.provider.field.oauthPath.kimi.placeholder': 'e.g.: configs/kimi/oauth_creds.json',
